package co.com.hulk.store.product.services.exception;
...
public class ErrorHandler {
	...
	public ResponseEntity<ErrorInfo> methodArgumentNotValidException(HttpServletRequest request,
		...
		fieldErrors.forEach(f -> errorMessage.append(
				(f.getField() != null ? "[" + f.getField().toUpperCase() + "] " : "") + f.getDefaultMessage() + " "));
